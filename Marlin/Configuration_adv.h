 ...
 * if the firmware gets too overloaded to read the Htemperature sensors.
 *
...
#define ARC_SUPPORT               // Disable this feature to save ~3226 bytes
  ...
  #define MM_PER_ARC_SEGMENT  .5 // Length of each arc segment
...
/**
 * Auto-report voltagess with M155 S<seconds>
 */
#define AUTO_REPORT_VOLTAGES
