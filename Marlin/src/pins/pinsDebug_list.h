...
// Plasma
  ...
  #if PIN_EXISTS(VOLTAGE_DIVIDER_PLUS) //&& ANALOG_OK(VOLTAGE_DIVIDER_PLUS_PIN)
    REPORT_NAME_ANALOG(__LINE__, VOLTAGE_DIVIDER_PLUS_PIN)
  #endif
  #if PIN_EXISTS(VOLTAGE_DIVIDER_MINUS) //&& ANALOG_OK(VOLTAGE_DIVIDER_MINUS_PIN)
    REPORT_NAME_ANALOG(__LINE__, VOLTAGE_DIVIDER_MINUS_PIN)
  #endif
#endif
...
// Plasma pins
#if ANY(MPCNC_PLASMA, COREXY_PLASMA)
  #if PIN_EXISTS(PLASMA_START)
    REPORT_NAME_DIGITAL(__LINE__, PLASMA_START_PIN)
  #endif
  #if PIN_EXISTS(PLASMA_TRANSFER)
    REPORT_NAME_DIGITAL(__LINE__, PLASMA_TRANSFER_PIN)
  #endif
  #if PIN_EXISTS(PLASMA_VD_UPDATES)
    REPORT_NAME_DIGITAL(__LINE__, PLASMA_VD_UPDATES_PIN)
  #endif
#endif
